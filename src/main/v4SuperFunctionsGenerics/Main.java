...
public class Main {
    ...
    public Main() {
        ...
        List<Integer> squares = SuperFunctions.transformation(pairs, new OperadorUnario<>() {
            @Override
        ...
        Integer total = SuperFunctions.reduce(displayed, 0, new OperadorBinario<>() {
            @Override
        ...
        List<String> stringConverted = SuperFunctions.transformation(pairs, new Function2<Integer, String>() {
            @Override
